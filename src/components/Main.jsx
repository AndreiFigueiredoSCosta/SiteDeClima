...
export default function Main() {
  ...
  return (
    <main className="sm:w-3/5 h-5/6 sm:h-5/6 py-10 z-40 flex flex-col items-center justify-center text-white bg-black/50 backdrop-blur-sm rounded-3xl font-inter space-y-6 overflow-hidden">
      <Pesquisar
